    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
          Conducted comparative analysis on JSM and ZT JAVA based on NIST ZTA principles for software security. Research accepted at ICSE'25 and contributed to multiple USENIX papers.
        </p>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <Card className="p-8 bg-card-gradient border-primary/20">
            ...
            <div className="flex flex-wrap gap-2">
              {["Cybersecurity", "Zero Trust", "Java", "Security Analysis", "Research"].map((tech) => (
          ...
          <Card className="p-8 bg-card-gradient border-primary/20">
            ...
            <ul className="space-y-3 text-muted-foreground">
              <li>• NIST ZTA principles implementation</li>
              <li>• JSM and ZT JAVA comparison</li>
              <li>• Research publication at ICSE'25</li>
              <li>• USENIX paper contributions</li>
